...
<html lang="en">
    <head>
        ...
        <!-- base css -->
        <link id="vendorsbundle" rel="stylesheet" media="screen, print" href="<?= base_url('_assets/_admin'); ?>/css/vendors.bundle.css">
        ...
        <link rel="mask-icon" href="<?= base_url('_assets/_admin'); ?>/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
        <link rel="stylesheet" media="screen, print" href="<?= base_url('_assets/_admin'); ?>/css/datagrid/datatables/datatables.bundle.css">
    </head>
    <!-- BEGIN Body -->
    <!-- Possible Classes
            ...
            <div class="page-inner">
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            ...
                            <span class="page-logo-text mr-1">Mi Casa</span>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="<?= base_url('_assets/_images/_users'); ?>/ic4l.jpg" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                            ...
                            <img src="<?= base_url('_assets/_admin'); ?>/img/card-backgrounds/cover-2-lg.png" class="cover" alt="cover">
                ...
                <div class="page-content-wrapper">
                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="page-logo">
                            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                                <img src="<?= base_url('_assets/_admin'); ?>/img/logo.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
                        ...
                        <div class="ml-auto d-flex">
                                            ...
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <!-- <img src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-m.png" data-src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-h.png" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
                                        ...
                                        <div class="tab-pane" id="tab-feeds" role="tabpanel">
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-m.png" data-src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-k.png" class="profile-image rounded-circle" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                                <span class="name">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-m.png" data-src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-e.png" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-m.png" data-src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-h.png" class="profile-image rounded-circle align-self-start mt-1" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                                <div class="name mb-2">
                            ...
                            <div>
                                <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-admin.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="<?= base_url('_assets/_admin'); ?>/img/demo/avatars/avatar-admin.png" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
