...
<header class="page-header" role="banner">
    ...
    <div class="ml-auto d-flex">
        ...
        <!-- app user menu -->
        <div>
            <a href="#" data-toggle="dropdown" title="<?= user()->email ?>" class="header-icon d-flex align-items-center justify-content-center ml-2">
                <img src="<?= base_url('_assets/_images/_users/'.user()->image); ?>" class="profile-image rounded-circle" alt="<?= user()->fullname ?>">
            </a>
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                        <span class="mr-2">
                            <img src="<?= base_url('_assets/_images/_users/'.user()->image); ?>" class="rounded-circle profile-image" alt="<?= user()->fullname ?>">
                        </span>
                ...
                <a href="<?= base_url('profile'); ?>" class="dropdown-item" data-action="app-reset">
