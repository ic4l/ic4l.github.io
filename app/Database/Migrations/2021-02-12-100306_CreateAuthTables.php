...
class CreateAuthTables extends Migration
{
	public function up()
	{
			...
			$this->forge->addField([
					...
					'fullname'         => ['type' => 'varchar', 'constraint' => 128, 'null' => true],
					'nickname'         => ['type' => 'varchar', 'constraint' => 128, 'null' => true],
					'pob'              => ['type' => 'varchar', 'constraint' => 32, 'null' => true],
					'dob'              => ['type' => 'date', 'null' => true],
					'gender'           => ['type' => 'varchar', 'constraint' => 12, 'null' => true],
					'mobile'           => ['type' => 'varchar', 'constraint' => 32, 'null' => true],
					'facebook'         => ['type' => 'varchar', 'constraint' => 64, 'null' => true],
					'instagram'        => ['type' => 'varchar', 'constraint' => 64, 'null' => true],
					'twitter'          => ['type' => 'varchar', 'constraint' => 64, 'null' => true],
					'address'          => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
					'image'            => ['type' => 'varchar', 'constraint' => 64, 'null' => true, 'default' => 'default.png'],
			 ...
			 */
			$fields = [
					'upid'           => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
					'user_id'       => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
					'permission_id' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'default' => 0],
			];

			$this->forge->addKey('upid', true);
			$this->forge->addField($fields);
